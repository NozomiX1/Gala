...
| `artemis-d3d11` | Artemis/iarsys D3D11, e.g. 甜蜜女友3 / アマカノ3 | DXMT v0.80 Wine variant plus native `d3dcompiler_47` |

## Known Bugs And Fixes
| Symptom | Root Cause | Working Fix |
| --- | --- | --- |
...
| 甜蜜女友3 / アマカノ3 black screen with audio | Main D3D11 rendering issue, not OP/DirectShow | `artemis-d3d11` profile uses DXMT v0.80 builtin and `d3dcompiler_47=native,builtin` |
